...
/**
 * Allow only the gutenberg blocks ('ytvideo', 'testquestion', 'multiple-choice') in the post type 'lesson';
...
function learningaid_allowed_block_types($allowed_block_types, $post)
{
    if ($post->post_type === 'lesson') :
        return array('learning-aid/block-textquestion', 'learning-aid/block-ytvideo', 'learning-aid/block-multiple-choice');
    else :
